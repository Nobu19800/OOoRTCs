...
basetest_spec = ["implementation_id", "BaseTest", 
		 "type_name",         "BaseTest", 
...
# 
# 
class BaseTest(OpenRTM_aist.DataFlowComponentBase):
...
def BaseTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=basetest_spec)
    manager.registerFactory(profile,
                            BaseTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    BaseTestInit(manager)
